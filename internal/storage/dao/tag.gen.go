...
func newTag(db *gorm.DB, opts ...gen.DOOption) tag {
	...
	_tag.Icon = field.NewString(tableName, "icon")
	_tag.Description = field.NewString(tableName, "description")
	_tag.SortOrder = field.NewInt(tableName, "sort_order")
	_tag.CardCount = field.NewInt(tableName, "card_count")
	...
	_tag.CardTags = tagHasManyCardTags{
		...
		Card: struct {
			...
			RelationField: field.NewRelation("CardTags.Card", "models.Card"),
			Knowledge: struct {
				field.RelationField
				Parent struct {
					field.RelationField
				...
				RelationField: field.NewRelation("CardTags.Card.Knowledge", "models.Knowledge"),
				Parent: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("CardTags.Card.Knowledge.Parent", "models.Knowledge"),
				},
				FSRSPreset: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("CardTags.Card.Knowledge.FSRSPreset", "models.FSRSParameter"),
				},
				Children: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("CardTags.Card.Knowledge.Children", "models.Knowledge"),
				},
				SourceDocuments: struct {
					field.RelationField
					Knowledge struct {
					...
					RelationField: field.NewRelation("CardTags.Card.Knowledge.SourceDocuments", "models.SourceDocument"),
					Knowledge: struct {
						field.RelationField
					}{
						RelationField: field.NewRelation("CardTags.Card.Knowledge.SourceDocuments.Knowledge", "models.Knowledge"),
					},
					Cards: struct {
						field.RelationField
					}{
						RelationField: field.NewRelation("CardTags.Card.Knowledge.SourceDocuments.Cards", "models.Card"),
					},
				},
				Cards: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("CardTags.Card.Knowledge.Cards", "models.Card"),
				},
			},
			SourceDocument: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("CardTags.Card.SourceDocument", "models.SourceDocument"),
			},
			Parent: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("CardTags.Card.Parent", "models.Card"),
			},
			CoverAsset: struct {
				field.RelationField
				Card struct {
				...
				RelationField: field.NewRelation("CardTags.Card.CoverAsset", "models.Asset"),
				Card: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("CardTags.Card.CoverAsset.Card", "models.Card"),
				},
			},
			SRS: struct {
				field.RelationField
				...
				RelationField: field.NewRelation("CardTags.Card.SRS", "models.CardSRS"),
				Card: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("CardTags.Card.SRS.Card", "models.Card"),
				},
			},
			Children: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("CardTags.Card.Children", "models.Card"),
			},
			Assets: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("CardTags.Card.Assets", "models.Asset"),
			},
			CardTags: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("CardTags.Card.CardTags", "models.CardTag"),
			},
		},
		Tag: struct {
			field.RelationField
			...
			RelationField: field.NewRelation("CardTags.Tag", "models.Tag"),
			CardTags: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("CardTags.Tag.CardTags", "models.CardTag"),
			},
		},
	}
...
func (t *tag) updateTableName(table string) *tag {
	...
	t.SortOrder = field.NewInt(table, "sort_order")
	t.CardCount = field.NewInt(table, "card_count")
...
func (t *tag) fillFieldMap() {
	...
	t.fieldMap["card_count"] = t.CardCount
...
func (t tag) clone(db *gorm.DB) tag {
	...
	t.CardTags.db = db.Session(&gorm.Session{Initialized: true})
	t.CardTags.db.Statement.ConnPool = db.Statement.ConnPool
	return t
}

func (t tag) replaceDB(db *gorm.DB) tag {
	t.tagDo.ReplaceDB(db)
	t.CardTags.db = db.Session(&gorm.Session{})
	return t
}

type tagHasManyCardTags struct {
	db *gorm.DB
...
func (a tagHasManyCardTags) Where(conds ...field.Expr) *tagHasManyCardTags {
	if len(conds) == 0 {
		return &a
	}
...
func (a tagHasManyCardTags) WithContext(ctx context.Context) *tagHasManyCardTags {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a tagHasManyCardTags) Session(session *gorm.Session) *tagHasManyCardTags {
	a.db = a.db.Session(session)
	return &a
}

func (a tagHasManyCardTags) Model(m *models.Tag) *tagHasManyCardTagsTx {
	return &tagHasManyCardTagsTx{a.db.Model(m).Association(a.Name())}
}

func (a tagHasManyCardTags) Unscoped() *tagHasManyCardTags {
	a.db = a.db.Unscoped()
	return &a
}

type tagHasManyCardTagsTx struct{ tx *gorm.Association }

func (a tagHasManyCardTagsTx) Find() (result []*models.CardTag, err error) {
	return result, a.tx.Find(&result)
}

func (a tagHasManyCardTagsTx) Append(values ...*models.CardTag) (err error) {
...
func (a tagHasManyCardTagsTx) Replace(values ...*models.CardTag) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a tagHasManyCardTagsTx) Delete(values ...*models.CardTag) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a tagHasManyCardTagsTx) Clear() error {
	return a.tx.Clear()
}

func (a tagHasManyCardTagsTx) Count() int64 {
	return a.tx.Count()
}

func (a tagHasManyCardTagsTx) Unscoped() *tagHasManyCardTagsTx {
	a.tx = a.tx.Unscoped()
	return &a
}
